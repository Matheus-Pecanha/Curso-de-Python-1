...
# produto1 = int(input('Quantidade do primeiro produto: '))
# produto11 = float(input('Valor do primeiro produto: '))

# produto2 = int(input('Quantidade do segundo produto: '))
# produto22 = float(input('Valor do segundo produto: '))

# valor_total_compra = (produto1 * produto11) + (produto2 * produto22)
# soma = produto1 + produto2

 
# print('--- Resumo da Compra ---')
# print('Quantidade total de produtos:', soma)
# print('Valor total da compra: R$', valor_total_compra)
